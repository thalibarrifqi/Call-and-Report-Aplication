		...
		<div class="row">
            ...
            <?php
                ...
                {   
                    ...
                    // update user data
                    $result = mysqli_query($koneksi, "INSERT INTO teknisi SET username='$username', password='$password', nik='$nik', nama='$nama', status=''");
			...
			<div class="col-md-10">
				...
				<form method="POST" action="addteknisi.php">
                    <table>

                        <tr> 
                            <td><label for="exampleFormControlInput1">NIK</label></td>
                            <td><input type="text" class="form-control" name="nik" id="exampleFormControlInput1" placeholder="NIK Teknisi"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Nama</label></td>
                            <td><input type="text" class="form-control" name="nama" id="exampleFormControlInput1" placeholder="Nama Teknisi"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Username</label></td>
                            <td><input type="text" class="form-control" name="username" id="exampleFormControlInput1" placeholder="Username Teknisi"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Password</label></td>
                            <td><input type="text" class="form-control" name="password" id="exampleFormControlInput1" placeholder="Password Teknisi"></td>
                        </tr>
