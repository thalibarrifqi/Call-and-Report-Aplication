...
<html lang="en">
  <head>
    ...
    <title>Update Data Conveyor</title>
	...
	<div class="container-fluid">
		<div class="row">
            ...
            {   
                ...
                // update user data
                $result = mysqli_query($koneksi, "UPDATE conveyor SET nama='$nama', username='$username', password='$password', qrcode='$qrcode' WHERE id='$id'");
            ...
            <!-- mendapatkan data id dari conveyor -->
            <?php
            ...
            $result = mysqli_query($koneksi, "SELECT * FROM conveyor WHERE id='$id'");
			...
			<div class="col-md-10">
				<br>
				<h3>Edit Data Conveyor</h3>
				<div id="clock"></div>
                <br>
				
				<form method="POST" action="editcon.php">
                    <table>

                        <tr>
                            <td><label for="exampleFormControlInput1">Nama</label></td>
                            <td><input type="text" class="form-control" name="nama" id="exampleFormControlInput1" placeholder="Nama Conveyor" value="<?php echo $nama ?>"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Username</label></td>
                            <td><input type="text" class="form-control" name="username" id="exampleFormControlInput1" placeholder="Username Conveyor" value="<?php echo $username ?>"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Password</label></td>
                            <td><input type="text" class="form-control" name="password" id="exampleFormControlInput1" placeholder="Password Conveyor" value="<?php echo $password ?>"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">QR Code</label></td>
                            <td><input type="text" class="form-control" name="qrcode" id="exampleFormControlInput1" placeholder="QR Code" value="<?php echo $qrcode ?>"></td>
                        </tr>
