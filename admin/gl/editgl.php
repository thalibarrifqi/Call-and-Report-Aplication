	...
	<div class="container-fluid">
		<div class="row">
            ...
            {   
                ...
                // update user data
                $result = mysqli_query($koneksi, "UPDATE gl SET nik='$nik', nama='$nama' WHERE id='$id'");
            ...
            $result = mysqli_query($koneksi, "SELECT * FROM gl WHERE id='$id'");
			...
			<div class="col-md-10">
				...
				<form method="POST" action="editgl.php">
                    <table>

                        <tr> 
                            <td><label for="exampleFormControlInput1">NIK GL</label></td>
                            <td><input type="text" class="form-control" name="nik" id="exampleFormControlInput1" placeholder="NIK GL" value="<?php echo $nik ?>"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Nama</label></td>
                            <td><input type="text" class="form-control" name="nama" id="exampleFormControlInput1" placeholder="Nama GL" value="<?php echo $nama ?>"></td>
                        </tr>
