...
$confirm_gl = mysqli_query($koneksi,"SELECT password FROM gl WHERE password='$pass_gl'");

$cekgl = mysqli_num_rows($confirm_gl);

if($cekgl > 0){
    $query=mysqli_query($koneksi,"UPDATE problem SET konfirmasi_gl='Terkonfirmasi' WHERE id='$id'");
