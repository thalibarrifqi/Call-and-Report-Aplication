		...
		<div class="row">
            ...
            <?php
                ...
                {   
                    ...
                    // update user data
                    $result = mysqli_query($koneksi, "INSERT INTO gl SET nik='$nik', nama='$nama'");
			...
			<div class="col-md-10">
				<br>
				<h3>Tambah Data GL</h3>
				<div id="clock"></div>
				<br>
				
				<form method="POST" action="addgl.php">
                    <table>

                        <tr> 
                            <td><label for="exampleFormControlInput1">NIK GL</label></td>
                            <td><input type="text" class="form-control" name="nik" id="exampleFormControlInput1" placeholder="NIK GL"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Nama</label></td>
                            <td><input type="text" class="form-control" name="nama" id="exampleFormControlInput1" placeholder="Nama GL"></td>
                        </tr>
