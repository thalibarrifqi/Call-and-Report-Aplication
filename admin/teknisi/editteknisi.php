	...
	<div class="container-fluid">
		<div class="row">
            ...
            {   
                ...
                // update user data
                $result = mysqli_query($koneksi, "UPDATE teknisi SET nik='$nik', nama='$nama', username='$username', password='$password' WHERE id='$id'");
            ...
            $result = mysqli_query($koneksi, "SELECT * FROM teknisi WHERE id='$id'");
			...
			<div class="col-md-10">
				<br>
				<h3>Edit Data Teknisi</h3>
				<div id="clock"></div>
				<br>
				
				<form method="POST" action="editteknisi.php">
                    <table>

                        <tr> 
                            <td><label for="exampleFormControlInput1">NIK Teknisi</label></td>
                            <td><input type="text" class="form-control" name="nik" id="exampleFormControlInput1" placeholder="NIK Teknisi" value="<?php echo $nik ?>"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="username" id="exampleFormControlInput1" placeholder="Username Teknisi" value="<?php echo $username ?>"></td>
                        </tr>

                         <tr>
                            <td><label for="exampleFormControlInput1">Password</label></td>
                            <td><input type="text" class="form-control" name="password" id="exampleFormControlInput1" placeholder="Password Teknisi" value="<?php echo $password ?>"></td>
                        </tr>
