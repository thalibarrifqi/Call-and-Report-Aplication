	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<!-- Tabel -->
				<br>
				<a class="btn  btn-primary" href="conveyor/addcon.php">Add User</a> |
				<a class="btn  btn-primary" href="conveyor/addconexcel.php">Import From Excel</a>
				<a style="float: right" class="btn  btn-primary" href="conveyor/deleteallconv.php">Delete All</a>
				<br>
				...
				<table class="table table-sm">
						...
						$query = mysqli_query($koneksi,"SELECT * FROM conveyor ORDER BY nama ASC");
						$nomor=1;
						foreach($query as $row){
							...
							<tbody>
								...
								<td>".$row['nama']."</td>
								<td>
								<a href='conveyor/editcon.php?id=$row[id]'>
									<span><img src='resource/icons8-edit2.png'>Edit</span>
								</a> 
								||
								<a href='conveyor/deletecon.php?id=$row[id]'>
