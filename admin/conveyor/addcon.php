...
<html lang="en">
  <head>
    ...
    <title>Tambah Data Conveyor</title>
		...
		<div class="row">
            ...
            <?php
                ...
                {   
                    ...
                    // add user data
                    $result = mysqli_query($koneksi, "INSERT INTO conveyor SET username='$username', password='$password', nama='$nama', qrcode='$qrcode'");
			...
			<div class="col-md-10">
				<br>
				<h3>Tambah Data Conveyor</h3>
				<div id="clock"></div>
                <br>
				
				<form method="POST" action="addcon.php" enctype="multipart/form-data">
                    <table>

                        <tr>
                            <td><label for="exampleFormControlInput1">Nama</label></td>
                            <td><input type="text" class="form-control" name="nama" id="exampleFormControlInput1" placeholder="Nama Conveyor"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Username</label></td>
                            <td><input type="text" class="form-control" name="username" id="exampleFormControlInput1" placeholder="Username Conveyor"></td>
                        </tr>

                        <tr>
                            <td><label for="exampleFormControlInput1">Password</label></td>
                            <td><input type="text" class="form-control" name="password" id="exampleFormControlInput1" placeholder="Password Conveyor"></td>
                        </tr>
