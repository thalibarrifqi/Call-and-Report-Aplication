	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<!-- Tabel -->
				<br>
				<a class="btn  btn-primary" href="teknisi/addteknisi.php">Add Teknisi</a> |
				<a class="btn  btn-primary" href="teknisi/addteknisiexcel.php">Import From Excel</a>
				<a style="float: right" class="btn  btn-primary" href="teknisi/deleteallteknisi.php">Delete All</a>
				<br>
				<br>
				<div class="container-fluid">
				<table class="table table-sm">
						...
						$query = mysqli_query($koneksi,"SELECT * FROM teknisi ORDER BY nama ASC");
						$nomor=1;
						foreach($query as $row){
							...
							<tbody>
								...
								<td>".$row['nama']."</td>
								<td>
								<a href='teknisi/editteknisi.php?id=$row[id]'>
								<span><img src='resource/icons8-edit2.png'>Edit</span>
								</a> 
								||
								<a href='teknisi/deleteteknisi.php?id=$row[id]'>
